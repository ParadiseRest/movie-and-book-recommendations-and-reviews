...
?>
    ...
    <section>
        <div class="container-fluid">
            <img src="Images/nwh.jpg" class="rounded float-start" alt="..." style="margin-right: 5vh;">
            <div class="container" style="color: aliceblue;">
                ...
                <table class="table" style="color: aliceblue;">
                    <h4 class="director">Director : <h4 class="directorName">Jon Watts</h4>
                    </h4>
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <tr>
                            <th scope="row">Benedict Cumberbatch as Doctor Strange</th>
                        </tr>
                        <tr>
                            <th scope="row">Andrew Garfield as Peter Parker / Spider-Man</th>
                        </tr>
                        <tr>
                            <th scope="row">Arian Moayed as Agent Cleary</th>
                        </tr>
                        <tr>
                            <th scope="row">Tom Hardy as Eddie Brock / Venom</th>
                        </tr>
                    </tbody>
                </table>
...
<section>
    ...
    <div style="margin: 5vh;">
        ...
        <p>
        <h5 style="color: aliceblue;">Peter Parker's secret identity is revealed to the entire world. Desperate for help, Peter turns to Doctor Strange to make the world forget that he is Spider-Man. The spell goes horribly wrong and shatters the multiverse, bringing in monstrous villains that could destroy the world.</h5>
        </p>
    </div>
    ...
    <div class="container-fluid">
        ...
        if (isset($_POST['submit'])) {
            ...
            if ($comment != "" && $movie_name != "" && $sentiment_value != "") {
                ...
                if ($data) {
                    echo "<script>alert('Comment has been uploaded successfullly.');
                             window.location = 'http://localhost/review/nwh.php';</script>";
                } else {
