...
?>
    ...
    <section>
        <div class="container-fluid">
            <img src="Images/past malice.jpg" class="rounded float-start" alt="..." style="margin-right: 5vh;">
            <div class="container" style="color: aliceblue;">
                <h1>Past Malice: An Emma Fielding Mystery</h1>
                <h4>Crime / Mystery</h4>
                <br>
                <br>
                <table class="table" style="color: aliceblue;">
                    <h4 class="director">Director : <h4 class="directorName">Kevin Fair</h4>
                    </h4>
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <tr>
                            <th scope="row">Fulvio Cecere as Sebastian</th>
                        </tr>
                        <tr>
                            <th scope="row">Ben Wilkinson as Victor Bradford</th>
                        </tr>
                        <tr>
                            <th scope="row"> Preston Vanderslice as Bray Chandler</th>
                        </tr>
                        <tr>
                            <th scope="row"> Sitara Hewitt as Adelle Fisher</th>
                        </tr>
                    </tbody>
                </table>
...
<section>
    ...
    <div style="margin: 5vh;">
        ...
        <p>
            <!----------SYNPOSIS--------------->
        <h5 style="color: aliceblue;">Archaeologist Emma Fielding is hired to consult on the acquisition of a castle-like estate that local legend states is cursed. But she finds herself in the middle of a murder case after discovering the body of the archaeologist she was hired to shadow in a secret chamber in the bowels of the huge building. Assisted by her friend, FBI special agent Jim Conner, Fielding must sift through clues and a long list of suspects, each of whom has their own reason for wanting the man dead, to determine who is the killer. </h5>
        <!--------------------------------->
        </p>
    </div>
...
('$movie_id','$movie_name','$comment','$sentiment_value','$current_user_id')";
    ...
    window.location = 'http://localhost/review/pastMalice.php';</script>";
                } else {
