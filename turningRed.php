...
<section>
    <div class="container-fluid">
        <img src="Images/turning red.jpg" class="rounded float-start" alt="..." style="margin-right: 5vh;">
        <div class="container" style="color: aliceblue;">
            <h1>Turning Red</h1>
            <h4>Adventure / Animation / Comedy</h4>
            <br>
            <br>
            <table class="table" style="color: aliceblue;">
                <h4 class="director">Director : <h4 class="directorName">Domee Shi</h4></h4>
                <thead>
                  <tr>
                ...
                <tbody>
                  <tr>
                    <th scope="row">Wai Ching Ho as Grandma</th>
                  </tr>
                  <tr>
                    <th scope="row">Ava Morse as Miriam</th>
                  </tr>
                  <tr>
                    <th scope="row">Finneas O'Connell as Jesse</th>
                  </tr>
                  <tr>
                    <th scope="row">Lori Tan Chinn as Auntie Chen</th>
                  </tr>
                </tbody>
              </table>
...
<section>
    ...
    <div style="margin: 5vh;" >
        ...
        <p>
            <!----------SYNPOSIS--------------->
        <h5 style="color: aliceblue;">Mei Lee (voice of Rosalie Chiang) is a confident, dorky 13-year-old torn between staying her mother's dutiful daughter and the chaos of adolescence. Her protective, if not slightly overbearing mother, Ming (voice of Sandra Oh), is never far from her daughter - an unfortunate reality for the teenager. And as if changes to her interests, relationships and body weren't enough, whenever she gets too excited (which is practically ALWAYS), she "poofs" into a giant red panda.</h5>
            <!--------------------------------->
        </p>
    </div>
...
<div class="container-fluid">
    ...
    window.location = 'http://localhost/review/turningRed.php';</script>";
                } else {
